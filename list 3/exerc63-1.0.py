...
qtd_de_espacos_iniciais=0 # na 1ª linha
...
while nro_da_linha_sendo_escrita<qtd_de_linhas:
    ...
    if nro_da_linha_sendo_escrita==qtd_de_linhas: # estou na primeira linha
        print() # pula linha
    elif nro_da_linha_sendo_escrita==1: # estou na última linha
